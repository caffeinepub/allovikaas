...
export function getLocalSkilledWorkerIcon(subcategory: string): string {
  if (!subcategory) {
    return '/assets/generated/icon-fallback.dim_128x128.png';
  }
